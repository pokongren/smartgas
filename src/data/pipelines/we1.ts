...
// ============== 生成管段 ==============
export const trunkPipelines = generatePipelines(trunkStations, '西一线干线', 'WE1_TRUNK', '#f59e0b', { initialPressure: 9.5, constantFlowRate: 2800 })
export const branch0Pipelines = generatePipelines(branch0Stations, '沁水煤层气管道', 'WE1_B0', '#fbbf24', { initialPressure: 8.0, constantFlowRate: 180 })
export const branch1Pipelines = generatePipelines(branch1Stations, '长铝支线', 'WE1_B1', '#fcd34d', { initialPressure: 7.5, constantFlowRate: 210 })
export const branch2Pipelines = generatePipelines(branch2Stations, '定合支线', 'WE1_B2', '#fde68a', { initialPressure: 6.8, constantFlowRate: 150 })
export const branch3Pipelines = generatePipelines(branch3Stations, '定合复线', 'WE1_B3', '#d97706', { initialPressure: 6.8, constantFlowRate: 230 })
export const branch4Pipelines = generatePipelines(branch4Stations, '南芜支线', 'WE1_B4', '#b45309', { initialPressure: 6.5, constantFlowRate: 120 })
export const branch5Pipelines = generatePipelines(branch5Stations, '常长支线', 'WE1_B5', '#92400e', { initialPressure: 6.2, constantFlowRate: 110 })
export const branch6Pipelines = generatePipelines(branch6Stations, '望亭电厂支线', 'WE1_B6', '#fef08a', { initialPressure: 5.8, constantFlowRate: 190 })
export const branch7Pipelines = generatePipelines(branch7Stations, '扬巴支线', 'WE1_B7', '#fbbf24', { initialPressure: 5.5, constantFlowRate: 80 })
export const branch8Pipelines = generatePipelines(branch8Stations, '金陵电厂支线', 'WE1_B8', '#fcd34d', { initialPressure: 5.2, constantFlowRate: 95 })
export const branch9Pipelines = generatePipelines(branch9Stations, '金坛储气库支线', 'WE1_B9', '#fde68a', { initialPressure: 7.0, constantFlowRate: 350 })
export const branch10Pipelines = generatePipelines(branch10Stations, '甪宝支线', 'WE1_B10', '#d97706', { initialPressure: 4.5, constantFlowRate: 160 })
export const branch11Pipelines = generatePipelines(branch11Stations, '金溧支线', 'WE1_B11', '#b45309', { initialPressure: 5.0, constantFlowRate: 140 })
export const branch12Pipelines = generatePipelines(branch12Stations, '西一线与青宁线青山-南京联络线', 'WE1_B12', '#92400e', { initialPressure: 5.8, constantFlowRate: 130 })
export const branch13Pipelines = generatePipelines(branch13Stations, '南京计量中心支线', 'WE1_B13', '#fef08a', { initialPressure: 5.5, constantFlowRate: 60 })
